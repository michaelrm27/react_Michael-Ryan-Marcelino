      ...
      <div className="container ps-lg-5">
        <form action="" id="form" onSubmit={handleSubmit(onSubmit)} aria-label="product-form">
          ...
          <div className="mt-lg-4">
            ...
            <input {...register("productName")} type="text" className="form-control" id="productname" style={{ width: 280 }} aria-label="input-product-name" />
          ...
          <div className="mt-lg-5">
            ...
            <select className="form-select" name="" id="productcategory" style={{ width: 280 }} {...register("productCategory")} aria-label="input-product-category">
          ...
          <div className="form-check" name="formcheck" id="radio">
            <label className="form-check-label active">
              {" "}
              <input className="form-check-input" type="radio" name="Freshness" defaultValue="Brand New" {...register("productFreshness")} aria-label="brandnew" /> Brand New{" "}
            </label>{" "}
            <br />
            <label className="form-check-label">
              {" "}
              <input className="form-check-input" type="radio" name="Freshness" defaultValue="Second Hand" {...register("productFreshness")} aria-label="secondhand" /> Second Hand{" "}
            </label>{" "}
            <br />
            <label className="form-check-label">
              {" "}
              <input className="form-check-input" type="radio" name="Freshness" defaultValue="Refurbished" {...register("productFreshness")} aria-label="refurbished" /> Refurbished{" "}
            </label>
